...
class QuizFactory {
    ...
    func loadTheme(_ theme: inout ThemeModel, themeName: String) {
        switch themeName {
        case "music":
            theme = ThemeModel(name: "Музыка",
        ...
        case "tech":
            theme = ThemeModel(name: "Технологии",
        ...
        case "history":
            theme = ThemeModel(name: "История и культура",
        ...
        case "politics":
            theme = ThemeModel(name: "Политика и бизнес",
