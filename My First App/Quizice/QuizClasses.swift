...
var chosenTheme: ThemeModel = chosenMusicTheme // переделать
public var chosenThemeQuestionsArray: [String] = Array(chosenTheme.questionsAndAnswers.keys).shuffled()


let chosenMusicTheme = ThemeModel(name: "Музыка",
...
let chosenTechTheme = ThemeModel(name: "Технологии",
...
let chosenHistoryTheme = ThemeModel(name: "История и культура",
...
let chosenPoliticsTheme = ThemeModel(name: "Политика и бизнес",
